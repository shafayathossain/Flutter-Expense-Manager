...
typedef void CreateCategoryDialogCallback(String name, int color);

class CreateCategoryDialog extends StatelessWidget {

  final CreateCategoryDialogCallback callback;

  CreateCategoryDialog(this.callback);
                  ...
                  RawMaterialButton(
                    ...
                    onPressed: () {
                      if(_formKey.currentState.validate() && color != -1) {
                        context.read<CreateCategoryDialogCallback>().call(accountNameTextController.text.toString(), color);
                        Navigator.pop(context);
                      } else {
                        if(color == -1) {
